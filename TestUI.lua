...
local function addScript(title, imageUrl, scriptCode)
    local scriptFrame = Instance.new("Frame")
    scriptFrame.Parent = SearchFrame
    scriptFrame.Size = UDim2.new(1, 0, 0.2, 0)
    scriptFrame.BackgroundColor3 = Color3.fromRGB(70, 70, 70)
    ...
    image.Parent = scriptFrame
    image.Size = UDim2.new(0.2, 0, 1, 0)
    image.Image = imageUrl

    scriptFrame.MouseButton1Click:Connect(function()
