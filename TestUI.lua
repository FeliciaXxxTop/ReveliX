...
_G.is_Revelixandroid_loaded = true
local G2L = {};
G2L["1"] = Instance.new("ScreenGui", gethui());
G2L["1"]["Name"] = [[RevelixGui]];
...
G2L["27"]["Image"] = [[rbxassetid://128757719503511]];
...
G2L["133"]["Image"] = [[rbxassetid://128757719503511]];
G2L["133"]["Size"] = UDim2.new(0.07388234883546829, 0, 0.1319999247789383, 0);
G2L["133"]["Name"] = [[FloatingIcon]];
G2L["133"]["Visible"] = false;
G2L["133"]["AnchorPoint"] = Vector2.new(0.5, 0) 
G2L["133"]["Position"] = UDim2.new(0.5, 0, 0, 0) 
...
local function C_fd()
    ...
    local function AddTab(imageTab, creator, scriptname, source)
        ...
        save.MouseButton1Click:Connect(function()
            ...
            game.StarterGui:SetCore("SendNotification", {
                Title = "ReveliX Android";
                Text = "Successfully saved the script in the script hub";
                Duration = 5;
            })
        end)
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        local searchedquery = G2L["ce"].Text
        local page = 1
        local totalPages = 1 
        local isLastPage = false
        while not isLastPage do
            local url = "https://scriptblox.com/api/script/search?q=" .. UrlEncode(searchedquery) .. "&max=20&mode=free&page=" .. page
            ...
            if response and response.StatusCode == 200 then
                ...
                totalPages = decoded.result.totalPages
...
local function C_110()
	...
	local btn = script.Parent
	btn.MouseButton1Click:Connect(function()
		setclipboard("https://discord.gg/Ad62dDHftc")
        game.StarterGui:SetCore("SendNotification", 
    {
    Title = "ReveliX Android";
...
task.spawn(C_135);
load_saved_scripts()
if isfile("theme.revelix") then
    local HttpService = game:GetService("HttpService")
local json = readfile("theme.revelix")
...
local gui = gethui().RevelixGui
local BG = gui.MainUi.MainFrame
BG.BackgroundColor3 = BgColor
gui.FloatingIcon.BackgroundColor3 = BgColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.MakeScript.TitleScript.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Scripts.TitleScript.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.JumpPower.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.Gravity.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.Credits.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.InviteLink.BackgroundColor3 = MenuColor
    gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.UnlockFPS.BackgroundColor3 = MenuColor
task.spawn(function()
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Scripts.Scripts.Folder.LIST.BackgroundColor3 = MenuColor
	gethui().RevelixGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.LIST.TitleScript.BackgroundColor3 = MenuColor
	for _, script in pairs(gethui().RevelixGui.MainUi.MainFrame.Tabs.MakeScript.Scripts.ScriptFrame:GetChildren()) do
		if script.Name == "LIST" then
			script.TitleScript.BackgroundColor3 = MenuColor
		end
	end
	for _, script in pairs(gethui().RevelixGui.MainUi.MainFrame.Tabs.Scripts.Scripts.ScriptFrame:GetChildren()) do
...
task.spawn(function()
	for _, inside in pairs(gethui().RevelixGui.MainUi.MainFrame.Tabs:GetDescendants()) do
	...
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.Gravity.Reset.BackgroundColor3 = SettingBtnColor
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.Gravity.Set.BackgroundColor3 = SettingBtnColor
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.Gravity.TextBox.BackgroundColor3 = SettingBtnColor
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.JumpPower.Set.BackgroundColor3 = SettingBtnColor
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.JumpPower.TextBox.BackgroundColor3 = SettingBtnColor
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.Set.BackgroundColor3 = SettingBtnColor
	gethui().RevelixGui.MainUi.MainFrame.Tabs.Settings.WalkSpeed.TextBox.BackgroundColor3 = SettingBtnColor
end)
if(data.editor_image ~= "") then
local ImageFile = "Revelix_theme_image"
local ImageTransparency = data.image_opacity
gethui().RevelixGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.Editor.Image = getcustomasset(ImageFile)
gethui().RevelixGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.Editor.Image = getcustomasset(ImageFile)
gethui().RevelixGui.MainUi.MainFrame.Tabs.Home.ScriptTextbox.TextboxBar.Editor.ImageTransparency = ImageTransparency
gethui().RevelixGui.MainUi.MainFrame.Tabs.MakeScript.ScriptTextbox.TextboxBar.Editor.ImageTransparency = ImageTransparency
end
end
