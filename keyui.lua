...
-- Check if Verify_Key method exists before calling
if isfile("Key.txt") and KeySys.Verify_Key and (KeySys:Verify_Key(readfile("Key.txt")) == trueData or KeySys:Verify_PremiumKey(readfile("Key.txt")) == trueData) then
    _auto()
    ...
    checkKeyButton.MouseButton1Click:Connect(function()
        ...
        if (KeySys:Verify_Default and KeySys:Verify_Default(enteredKey) == trueData or KeySys:Verify_PremiumKey and KeySys:Verify_PremiumKey(enteredKey) == trueData) then
